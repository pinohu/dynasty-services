# Directory + SuiteDash Bundle — Business-in-a-Box

## Package Overview
- **Vertical:** Directories
- **Setup Fee:** $8,500
- **Monthly Retainer:** $1,000/mo
- **Delivery Timeline:** 3 weeks
- **Stripe Product:** prod_dynasty_dir_suite
...
| Objection | Response |
|-----------|----------|
| "Too expensive" | "What's the cost of NOT automating? $1000/mo replaces $X,000 in manual labor." |
...
### Close Script
"Based on what you've shared, here's what I recommend: [Package Name] at $8,500 setup + $1,000/month. I can have it live in 3 weeks. Want me to send the proposal?"
...
1. **include package** — {"action":"include_package","ref":"dir-turnkey"}
2. **provision suitedash workspace** — {"action":"provision_suitedash_workspace"}
3. **create member onboarding workflow** — {"action":"create_member_onboarding_workflow"}
4. **setup automated invoicing** — {"action":"setup_automated_invoicing"}
5. **configure documentero templates** — {"action":"configure_documentero_templates"}
6. **create engagement scoring** — {"action":"create_engagement_scoring"}
7. **create renewal workflow** — {"action":"create_renewal_workflow"}
8. **create churn prevention workflow** — {"action":"create_churn_prevention_workflow"}
9. **create ops dashboard** — {"action":"create_ops_dashboard"}
...
- [ ] **Ops Playbook** — Branded PDF delivered to client
- [ ] **Churn Prevention Guide** — Branded PDF delivered to client
...
### n8n Workflow: Directory + SuiteDash Bundle Onboarding
...
### Package Economics
- **Setup revenue:** $8,500
- **Monthly recurring:** $1,000/mo
- **Annual recurring per client:** $12,000
- **Estimated delivery cost:** ~1375/project (tools + time)
- **Gross margin:** ~85%
...
**Solution:** Dynasty Empire built a comprehensive directory + suitedash bundle system using production-grade infrastructure.
